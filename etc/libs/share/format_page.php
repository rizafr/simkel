...
class format_page {
	...
	public function showPage($totalData, $numToDisplay, $currentPage, $divId, $modul, $param1, $param2, $param3, $param4)
	{
		...
		else
		{
			...
			$keluaran = $keluaran." 	 	<a title=\"Klik untuk langsung ke halaman ... \" onclick=\"jumpto('$divId', '$totalPages','$totalPages','$fungsi', '$param1', '$param2', '$param3', '$param4'); return false;\" href=\"#pageCursor\">Halaman $currentPage dari $totalPages</a> &bull;";			
		}
