...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2014 at 10:24 AM
...
DROP TABLE IF EXISTS `permintaan_ajb`;
...
DROP TABLE IF EXISTS `permintaan_belum_bekerja`;
...
DROP TABLE IF EXISTS `permintaan_domisili_panitia_pembangunan`;
...
DROP TABLE IF EXISTS `permintaan_domisili_penduduk`;
...
DROP TABLE IF EXISTS `permintaan_kipem`;
...
DROP TABLE IF EXISTS `permintaan_kk`;
...
DROP TABLE IF EXISTS `permintaan_ktp`;
...
DROP TABLE IF EXISTS `permintaan_lahir_baru`;
...
DROP TABLE IF EXISTS `permintaan_mati_baru`;
...
DROP TABLE IF EXISTS `permintaan_na`;
...
DROP TABLE IF EXISTS `permintaan_orang_yang_sama`;
...
DROP TABLE IF EXISTS `permintaan_pbb_mutasi`;
...
DROP TABLE IF EXISTS `permintaan_pbb_penerbitan`;
...
DROP TABLE IF EXISTS `permintaan_pbb_split`;
...
DROP TABLE IF EXISTS `permintaan_sertifikat`;
